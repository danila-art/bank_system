...
def get_seria(): # Функция добавления seria
    while True:
        ...
        print(len(input_seria))
        print(input_seria.isdigit())
        if(input_seria == ''):
            print("Вы ничего не ввели, попробуйте ещё раз")
        elif(int(len(input_seria)) > 4 and int(len(input_seria)) < 4):
            print("Серия паспорт не может быть больше или меньше 4 символов, попробуйте ещё раз")
...
def get_number(): # Функция добавления number
    while True:
        ...
        print(input_number.isdigit())
        if(input_number == ''):
            print("Вы ничего не ввели, попробуйте ещё раз")
        elif(int(len(input_number)) > 6 and int(len(input_number)) < 6):
            print("Серия паспорт не может быть больше или меньше 6 символов, попробуйте ещё раз")
